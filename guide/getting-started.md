...
This guide walks you through installing Hey Listen and getting your first alert.
...
Hey Listen now runs in the background. When a calendar event is coming up, a full-screen alert will appear at your configured lead time.

**What happens next:**
- The alert shows the event title, start time, and a countdown.
- If the event has a meeting link, a **Join Meeting** button appears.
- You can snooze for a few minutes, snooze until just before the event, or dismiss.
- If your Mac was asleep when an alert was due, it fires as soon as you wake up (as long as the event hasn't ended).

---

## Next Steps

- [Alerts](alerts.md) — Fine-tune timing, screen mode, RSVP filtering, and more
- [Menu Bar](menu-bar.md) — Customize what appears next to the menu bar icon
- [Muting](muting.md) — Silence alerts for events you don't need reminders for
